...
创建型 | 组合型 | 行为型
----|----|----
工厂模式<br>单例模式<br>原型模式 | 适配器模式<br>装饰器模式<br>代理模式<br>外观模式<br>桥接模式<br>组合模式<br>享元模式 | 观察者模式<br>迭代器模式<br>状态模式<br>策略模式<br>命令模式<br>职责链模式<br>模板方法模式<br>备忘录模式<br>访问者模式<br>中介者模式<br>解释器模式
